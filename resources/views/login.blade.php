    ...
    <div class="row d-flex align-items-center justify-content-center h-100">
        <div class="col-4">
            <div class="card">
                ...
                <h4 class="m-0">Sistem Informasi Monitoring Desa</h4>
                <p class="mb-5 mt-2 text-muted">@2025. Inspektorat Kabupaten Probolinggo </p>
                @if (session('success'))
                <div
                ...
                <form action="{{ route('loginPost') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-merge">
                            <input id="password_2" type="password" name="password" required="" class="form-control"

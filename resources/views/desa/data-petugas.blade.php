                ...
                <tbody>
                    @foreach ($petugas as $item)
                        <tr>
                            ...
                            <td><img src="{{ asset('storage/' . $item->photo) }}" alt="" srcset="" class="img-fluid" style="width: 100px; height: 100px; object-fit: cover"></td>
                            ...
                            <td>
                                {{-- <a href="{{ route('data-petugas.edit', $item->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                <a href="{{ route('data-petugas.destroy', $item->id) }}" class="btn btn-danger btn-sm">Delete</a> --}}
                            </td>
                        </tr>
                    @endforeach
                </tbody>

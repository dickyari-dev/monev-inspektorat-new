...
<div class="container-fluid page__heading-container">
    <div class="page__heading d-flex align-items-end">
        <div class="flex">
            ...
            <h1 class="m-0">Jadwal monev Desa</h1>
        </div>
    </div>
</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="kecamatan_id" id="kecamatan_id" class="form-control"
                                        required readonly>
                                        <option value="{{ $kecamatanAuth->id }}" selected>{{ $kecamatanAuth->nama_kecamatan }}</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('monitoring.detail', ['waktu' => $item->id, 'kecamatan' => $kecamatanAuth->id]) }}"
